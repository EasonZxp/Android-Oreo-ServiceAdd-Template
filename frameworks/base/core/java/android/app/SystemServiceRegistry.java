...
final class SystemServiceRegistry {
    ...
    static {
        ...
        registerService(Context.KDCDMSI_SERVICE, KdcDmsiManager.class,
                new CachedServiceFetcher<KdcDmsiManager>() {
            @Override
            public KdcDmsiManager createService(ContextImpl ctx) {
                IBinder iBinder = ServiceManager.getService(Context.KDCDMSI_SERVICE);
                if (iBinder == null) {
                    return null;
                }
                IKdcDmsiManager service = IKdcDmsiManager.Stub
                        .asInterface(iBinder);
                return new KdcDmsiManager(service);
            }});
